<?php echo "<h2>Informationen zur Anmeldung</h2>
...
<hr/>
<h2>Anmeldung – leicht gemacht!</h2>
<p>Wir bedanken uns herzlich bei Nina Röckelein aus der K2, die die Programmierung der Online-Anmeldung übernommen und damit – unterstützt durch Herrn Lohner - dieses vereinfachte Anmeldeverfahren ermöglicht hat. 
<ol class='alert alert-success'>
<li> Bitte tragen Sie zunächst alle Schülerdaten ein (Name, Klasse, Kontakt/ Mailadresse) </li>

<li> Klicken Sie die Kurse an, die besucht werden sollen. Pro Tag und Schüler sind maximal 3 Kurse möglich, jeweils nur ein Kurs pro Zeitschiene. Freie Plätze werden angezeigt. Sollte ein Kurs schon voll sein, können Sie uns kontaktieren: elternbeirat@eg.schulen.konstanz.de . Wir prüfen, ob es möglich ist, einen zusätzlichen Kurs zum Thema einzuplanen.</li>

<li> Erst, wenn Sie alle Kurse, an denen Ihr Kind die Woche über teilnehmen soll, markiert haben, schließen Sie die Anmeldung ab: button „Abschicken“ drücken. </li>

<li> Sie erhalten kurz darauf eine Anmeldebestätigung per Mail. Sollte diese Sie nicht erreichen, melden Sie sich bitte bei uns unter elternbeirat@eg.schulen.konstanz.de.</li>

<li> Erst nach Ablauf der Anmeldefrist erhalten alle angemeldeten Schüler eine verbindliche Teilnahmebestätigung per Mail mit ihrem individuellen Ferienschul-Stundenplan. </li>
</ol>
Bitte beachten Sie: 
